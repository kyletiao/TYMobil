...
public class LoginNameEditText extends LinearLayout {
	...
	public LoginNameEditText(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs);
		initView(context);
	}

	public LoginNameEditText(Context context, AttributeSet attrs) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		View view = View.inflate(context, R.layout.edittext_check_loginname, null);
