...
public class LoginPassEditText extends LinearLayout {
	...
	public LoginPassEditText(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs);
		initView(context);
	}
	...
	private void initView(Context context) {
		View view = View.inflate(context, R.layout.edittext_check_loginpass, null);
