...
public class VideoView extends SurfaceView implements MediaPlayerControl {
	...
	public void setVideoPath(String path,int time) {
		setVideoURI(Uri.parse(path),time);
	}

	public void setVideoURI(Uri uri,int time) {
		mUri = uri;
	...
	public boolean sendHttpRequest(String channelId, String serverInfo,String link,
			String cmd) {
		URL url = null;
		String tempStr = null;
		try {
			...
			String urlInfo = "http://127.0.0.1:9906/cmd.xml?cmd=" + cmd
					+ "&id=" + channelId + "&server=" + serverInfo +"&link="+link;
			url = new URL(urlInfo);
