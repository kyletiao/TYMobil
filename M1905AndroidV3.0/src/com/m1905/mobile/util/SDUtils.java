...
public class SDUtils {
	...
	public static long getCacheSize() {
		return getFileSize(new File(AppConfig.M1905_CACHE_PATH));
	}
	...
	public static void deleteExpiredCacheFile() {
		deleteExpiredFile(new File(AppConfig.M1905_CACHE_PATH), true,
	...
	public static void deleteCacheFile() {
		// 主目录
		deleteFile(new File(AppConfig.M1905_HOME_PATH), false);
		// 缓存目录
		deleteFile(new File(AppConfig.M1905_CACHE_PATH), true);
	}
	...
	public static void initAppDirectory() {
		createDirectory(new File(AppConfig.M1905_HOME_PATH), true);
		createDirectory(new File(AppConfig.M1905_CACHE_PATH), true);
		createDirectory(new File(AppConfig.M1905_MOVIE_PATH), true);
	 ...
	 * @return
	 */
	public static boolean findSplash(String splashUrl) {
